...
lookUpSlackEmoji <- function() {
  ...
  englandTwo <- paste0(':england-', 
                       c('not', 'sun', 'bur', 'pre', 'ful', 'bri', 'ips', 
                         'ast', 'que', 'wol', 'bol', 'car', 'mil', 'bir', 
                         'der', 'hul', 'rea', 'mid', 'bre', 'she', 'lee',
                         'bar', 'nor'),
                       ':')
  englandTwoIds <- c(9297, 9384, 9074, 9317, 9175, 9066, 9227, 9008, 9318, 9446, 
  ...
  germany <- paste0(':germany-',
                    c('baymun', 'ham', 'her', 'hof', 'mai', 'wol', 'sha', 
